      ...
      <div className="about-container">
        <div className="about-text">
          ...
          <p>
            ...
            color, light, materiality, and space. These themes are addressed by
            the artist in a diverse range of media including painting, neon, and
            acrylic resin. Steigelman has exhibited at galleries, museums, and
            institutions, and recently participated in group exhibitions at
            Christie’s, New York (2020), Local Project, New York (2020), The
            Center for Holographic Arts x Plaxall Gallery, New York (2019),
            Cluster Gallery, New York (2019), Greenpoint Gallery, New York
            (2019), Blackbird Gallery, New York (2019), and Gallery 55, Brooklyn
            (2018). Steigelman was trained in painting at Parsons School of
            Design and Pratt Institute, and is a graduate of New York
            University.
          </p>
          <section className="about-presslinks">
            ...
            <p>
              ...
              (2019). Steigelman's work has also been featured on the official Instagram
              accounts of Christie's New York, Christie's Los Angeles, and
              Christie's Paris.{" "}
            </p>
          </section>
        </div>
